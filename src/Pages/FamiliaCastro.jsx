...
export function FamiliaCastro ({name, value}) {
    return (
        <div className="flex flex-col items-center">
            <main className="w-96 px-3 py-6 flex flex-col gap-6">
                ...
                <header>
                    <h1 className="flex w-full justify-center font-medium text-xl text-red-600">Familia Castro</h1>
                </header>

                <section>
                    <SaldCard value='$1.000.000'/>
                </section>
